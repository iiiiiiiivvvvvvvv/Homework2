...
$experience = [
    [
        'work_name' => 'Преподователь',
        'work_date' => 'Aug 2019 - May 2022',
        'work_descrip' => 'Преподаю информатику',
    ],
    [
        'work_name' => 'Тестировщик ПО',
        'work_date' => 'Sep 2020 - Dec 2022',
        'work_descrip' => 'Тестирую WEB',
    ],
    [
        'work_name' => 'Програмист',
        'work_date' => 'Jan 2022 - Current',
        'work_descrip' => 'Програмирую на PYTHON',
    ],
];
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h5 class="w3-opacity"><?php echo $experience[$i][ 'work_name']; ?> </h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['work_date']; ?> <span
                class="w3-tag w3-teal w3-round">Current</span></h6>
            <p><?php echo $experience[$i]['work_descrip']; ?></p>
            <hr>
            <?php endfor;?>
